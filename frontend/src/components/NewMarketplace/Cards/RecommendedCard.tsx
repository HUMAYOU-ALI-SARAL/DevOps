        ...
        >
            ...
            <div className="flex items-start justify-between mb-4 w-[100%]">
                <div className="flex items-center ">
                    <img src={collectionImage?collectionImage:R1.src} alt="Profile" className="rounded-lg h-[100px] max-w-[100px] overflow-hidden object-cover" />
                    <div className="ml-3 flex flex-col gap-4">
                        ...
                        {
                            exploreText && (
                                <span className="font-thin text-md flex h-[30px] w-[150px] mt-1">Slamdunk dynasty</span>
                            )
                        }
                        {showButton && (
