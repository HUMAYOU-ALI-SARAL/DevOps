                    ...
                    <thead className="bg-sp-gray-600">
                        <tr>
                            {tableHeader.map((name, index) => (
                                <th key={index} className="p-2 text-[15px]">{name}</th>
                            ))}
                        </tr>
                    </thead>
                    <tbody>
                        {activities.map((activity, index) => (
                            <tr key={`bid-${index}`} className="border-b border-sp-gray-700">
                                <td className="p-2 text-[15px] text-center capitalize">{activity.eventType}</td>
                                <td className="p-2 text-[15px] text-center">{tinyBarToHbar(activity?.price || 0n)}</td>
                                <td className="p-2 text-[15px] text-center text-orange">
                                ...
                                <td className="p-2 text-[15px] text-center">{formatDistanceToNowStrict(activity.timestamp)} {_t("ago")}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
