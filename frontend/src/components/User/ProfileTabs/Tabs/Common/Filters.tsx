...
const Filters = ({
  ...
  return (
    <>
      <div className="flex items-center justify-between gap-6 font-inter text-base mt-[-50px]">
        {/* {useActions && */}
        <div className="flex items-center gap-6 ">
          ...
          <Input
            leftAdornment={<SearchIcon className="text-placeholder cursor-pointer" onClick={onSearch} />}
            value={searchQuery}
            onChange={(event) =>
