...
async function main() {
  ...
  const nftCreate = new TokenCreateTransaction()
    .setTokenName(process.env.TOKEN_NAME3)
    .setTokenSymbol(process.env.TOKEN_SYMBOL3)
    .setTokenType(TokenType.NonFungibleUnique)
    .setDecimals(0)
    .setInitialSupply(0)
    .setTokenMemo(process.env.TOKEN_METADATA_IPFS_URL3)
    ...
    .setCustomFees([new CustomRoyaltyFee({
      ...
      numerator: process.env.TOKEN_ROYALTY_FEE_NUMERATOR3,
      denominator: process.env.TOKEN_ROYALTY_FEE_DENOMINATOR3,
      allCollectorsAreExempt: false,
    })])
    .setMaxSupply(process.env.TOKEN_MAX_SUPPLY3)
