...
async function main() {
  console.log(process.TREASURY_ACCOUNT_ID)
  // Create the NFT
  // CHANGE OPTIONS HERE
  const nftCreate = new TokenCreateTransaction()
    .setTokenName(process.env.TOKEN_NAME4)
    .setTokenSymbol(process.env.TOKEN_SYMBOL4)
    .setTokenType(TokenType.NonFungibleUnique)
    .setDecimals(0)
    .setInitialSupply(0)
    .setTokenMemo(process.env.TOKEN_METADATA_IPFS_URL4)
    ...
    .setCustomFees([new CustomRoyaltyFee({
      ...
      numerator: process.env.TOKEN_ROYALTY_FEE_NUMERATOR4,
      denominator: process.env.TOKEN_ROYALTY_FEE_DENOMINATOR4,
      allCollectorsAreExempt: false,
    })])
    .setMaxSupply(process.env.TOKEN_MAX_SUPPLY4)
