...
async function main() {
  ...
  const nftCreate = new TokenCreateTransaction()
    .setTokenName(process.env.TOKEN_NAME1)
    .setTokenSymbol(process.env.TOKEN_SYMBOL1)
    .setTokenType(TokenType.NonFungibleUnique)
    .setDecimals(0)
    .setInitialSupply(0)
    .setTokenMemo(process.env.TOKEN_METADATA_IPFS_URL1)
    ...
    .setCustomFees([new CustomRoyaltyFee({
      ...
      numerator: process.env.TOKEN_ROYALTY_FEE_NUMERATOR1,
      denominator: process.env.TOKEN_ROYALTY_FEE_DENOMINATOR1,
      allCollectorsAreExempt: false,
    })])
    .setMaxSupply(process.env.TOKEN_MAX_SUPPLY1)
