...
async function main() {
  ...
  const nftCreate = new TokenCreateTransaction()
    .setTokenName(process.env.TOKEN_NAME8)
    .setTokenSymbol(process.env.TOKEN_SYMBOL8)
    .setTokenType(TokenType.NonFungibleUnique)
    .setDecimals(0)
    .setInitialSupply(0)
    .setTokenMemo(process.env.TOKEN_METADATA_IPFS_URL8)
    ...
    .setCustomFees([new CustomRoyaltyFee({
      ...
      numerator: process.env.TOKEN_ROYALTY_FEE_NUMERATOR8,
      denominator: process.env.TOKEN_ROYALTY_FEE_DENOMINATOR8,
      allCollectorsAreExempt: false,
    })])
    .setMaxSupply(process.env.TOKEN_MAX_SUPPLY8)
