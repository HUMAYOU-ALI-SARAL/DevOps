...
async function main() {
  ...
  const nftCreate = new TokenCreateTransaction()
    .setTokenName(process.env.TOKEN_NAME7)
    .setTokenSymbol(process.env.TOKEN_SYMBOL7)
    .setTokenType(TokenType.NonFungibleUnique)
    .setDecimals(0)
    .setInitialSupply(0)
    .setTokenMemo(process.env.TOKEN_METADATA_IPFS_URL7)
    ...
    .setCustomFees([new CustomRoyaltyFee({
      ...
      numerator: process.env.TOKEN_ROYALTY_FEE_NUMERATOR7,
      denominator: process.env.TOKEN_ROYALTY_FEE_DENOMINATOR7,
      allCollectorsAreExempt: false,
    })])
    .setMaxSupply(process.env.TOKEN_MAX_SUPPLY7)
